...
muito_frio = FaixaTemperatura.create!(:classificacao_temperatura => FaixaTemperatura::MUITO_FRIO,
		:faixa_min => 0.0,
		:faixa_max => 7.0)
frio = FaixaTemperatura.create!(:classificacao_temperatura => FaixaTemperatura::FRIO,
		:faixa_min => 7.1,
		:faixa_max => 17.0)
normal = FaixaTemperatura.create!(:classificacao_temperatura => FaixaTemperatura::NORMAL,
		:faixa_min => 17.1,
		:faixa_max => 25.0)
quente = FaixaTemperatura.create!(:classificacao_temperatura => FaixaTemperatura::QUENTE,
		:faixa_min => 25.1,
		:faixa_max => 33.0)
muito_quente = FaixaTemperatura.create!(:classificacao_temperatura => FaixaTemperatura::MUITO_QUENTE,
		:faixa_min => 33.1,
		:faixa_max => 47.0)

faixas_temperatura = [muito_frio, frio, normal, quente, muito_quente]
...
roupas = PecaDeRoupa.create!([
	{
		...
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 2, 
		...
		:faixa_temperaturas => [muito_frio, frio, normal]
	},{
		:id_android => 7, 
		...
		:faixa_temperaturas => [normal, quente, muito_quente]
	},{
		:id_android => 16, 
		:descricao => "Saia Reta",
		...
		:faixa_temperaturas => [muito_frio, frio]
	},{
		:id_android => 25, 
		...
		:faixa_temperaturas => [quente, muito_quente]
	},{
		:id_android => 26, 
		...
		:id_android => 34, 
		:descricao => "Vestido Envelope Vermelho",
		:tipo_roupa_id => ModeloRoupa.find(24).tipo_roupa_id,
		:cor_id => 1,
		:estampada => false,
		:modelo_roupa_id => 24,
		:caminho_imagem => "http://msalx.elle.abril.com.br/2013/04/01/0645/vestido-envelope-dvf-div.jpeg",
		:faixa_temperaturas => [normal, quente, muito_quente]
	},{
		:id_android => 35, 
		:descricao => "Camisa verde agua",
		:tipo_roupa_id => ModeloRoupa.find(11).tipo_roupa_id,
		:cor_id => 4,
		:estampada => false,
		:modelo_roupa_id => 11,
		:caminho_imagem => "http://www.shoxbay.com/produtos/foto1/grande/Ref-2875.Camisa.Social-Feminina-Dudalina.Verde.Agua%20(1).jpg",
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 36, 
		...
		:estampada => false,
		:modelo_roupa_id => 11,
		:caminho_imagem => "http://img.elo7.com.br/product/main/544522/camisa-chiffon-amarela.jpg",
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 37, 
		:descricao => "Calça reta",
		...
		:estampada => false,
		:modelo_roupa_id => 6,
		:caminho_imagem => "http://static.dafity.com.br/p/Colcci-Cal%C3%A7a-Sarja-Colcci-Reta-Rodrigo-Vermelha-3917-6258911-1.jpg",
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 38, 
		:descricao => "Jaqueta Couro Marrom",
		:tipo_roupa_id => ModeloRoupa.find(27).tipo_roupa_id,
		:cor_id => 14,
		:estampada => false,
		:modelo_roupa_id => 27,
		:caminho_imagem => "http://www.camisariarg.com/media/catalog/product/cache/1/image/500x500/9df78eab33525d08d6e5fb8d27136e95/j/a/jaqueta-de-couro-feminina-32-06.jpg",
		:faixa_temperaturas => [muito_frio, frio, normal]
	},{
		:id_android => 40, 
		:descricao => "Camiseta",
		...
		:estampada => true,
		:modelo_roupa_id => 12,
		:caminho_imagem => "http://modanapassarela.com.br/wp-content/uploads/2012/10/6400284012-Blusa-Feminina.jpg",
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 43, 
		:descricao => "Sapatilha Smurf",
		:tipo_roupa_id => ModeloRoupa.find(19).tipo_roupa_id,
		:cor_id => 28,
		:estampada => false,
		:modelo_roupa_id => 19,
		:caminho_imagem => "http://www.docevidafashionstore.com.br/loja/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/s/a/sapatilha-melissa-wanting_smurfs.jpg",
		:faixa_temperaturas => [muito_frio, frio, normal, quente, muito_quente]
	},{
		:id_android => 44, 
		...
		:estampada => true,
		:modelo_roupa_id => 1,
		:caminho_imagem => "http://bimg2.mlstatic.com/mini-saia-pretapregueadarodada-rebelde-tam-14-veste-36_MLB-F-206525420_8104.jpg",
		:faixa_temperaturas => [normal, quente, muito_quente]
	},{
		:id_android => 45, 
		:descricao => "Saia de Oncinha",
		:tipo_roupa_id => ModeloRoupa.find(2).tipo_roupa_id,
		:cor_id => 24,
		:estampada => true,
		:modelo_roupa_id => 2,
		:caminho_imagem => "http://www.netlet.com.br/arquivos/ids/1636589-260-391/A580414100_0.jpg",
		:faixa_temperaturas => [normal, quente, muito_quente]
	}
])
